  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_ROWPLACE: {
          if ("layout/row_place_0".equals(tag)) {
            return new RowPlaceBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for row_place is invalid. Received: " + tag);
        }
      }
    }
    return null;
